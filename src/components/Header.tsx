...
export function Header({ onMenuClick, darkMode = false, onHomeClick, onLogout }: HeaderProps) {
  return (
      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <button 
              onClick={onHomeClick}
              className="bg-teal-500 text-white px-3 py-2 rounded-md font-bold flex items-center gap-2 hover:bg-teal-600 transition cursor-pointer"
              title="홈으로 이동"
            >
